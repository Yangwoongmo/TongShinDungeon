...
public class MonsterSwordMan : Monster
{
    ...
    private IEnumerator Pattern1Coroutine()
    {
        ...
        actionObserver.FireMonsterAttack(25, PlayerDirection.CENTER);
    ...
    private IEnumerator AttackPatternCoroutine()
    {
        ...
        while (!IsDead())
        {
            ...
            if ((rand <= 0.33f && successiveCountArray[0] < 2) || 
                (rand > 0.33f && successiveCountArray[1] >= 2))
            {
